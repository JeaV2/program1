    ...
    <div class="form-container">
        <form action="agenda_toevoegen_verwerk.php" method="post">
            <div class="form-group">
                ...
                <?php } ?>
                <input type="text" id="onderwerp" name="onderwerp" placeholder="Agenda item onderwerp..." value="<?= htmlspecialchars($onderwerp ?? '') ?>">
            </div>
            ...
            <div class="form-group">
                ...
                <?php } ?>
                <input type="text" id="inhoud" name="inhoud" placeholder="Agenda item inhoud..." value="<?= htmlspecialchars($inhoud ?? '') ?>">
            </div>
            ...
            <div class="form-group">
                ...
                <select name="status" id="status">
                    <option value="Nog niet begonnen" <?= (($status ?? '') == 'Nog niet begonnen') ? 'selected' : '' ?>>Nog niet begonnen</option>
